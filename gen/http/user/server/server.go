...
func New(
	...
	return &Server{
		...
		SendSmsCode:     NewSendSmsCodeHandler(e.SendSmsCode, mux, decoder, encoder, errhandler, formatter),
	}
}
...
// MountLoginBySmsCodeHandler configures the mux to serve the "User" service
// "LoginBySmsCode" endpoint.
func MountLoginBySmsCodeHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
...
// and calls the "User" service "LoginBySmsCode" endpoint.
func NewLoginBySmsCodeHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeLoginBySmsCodeRequest(mux, decoder)
		encodeResponse = EncodeLoginBySmsCodeResponse(encoder)
		encodeError    = EncodeLoginBySmsCodeError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "LoginBySmsCode")
		ctx = context.WithValue(ctx, goa.ServiceKey, "User")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil {
...
// MountSendSmsCodeHandler configures the mux to serve the "User" service
// "SendSmsCode" endpoint.
func MountSendSmsCodeHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
...
// and calls the "User" service "SendSmsCode" endpoint.
func NewSendSmsCodeHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeSendSmsCodeRequest(mux, decoder)
		encodeResponse = EncodeSendSmsCodeResponse(encoder)
		encodeError    = EncodeSendSmsCodeError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "SendSmsCode")
		ctx = context.WithValue(ctx, goa.ServiceKey, "User")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil {
