...
// NewLoginBySmsCodeResponseBody builds the HTTP response body from the result
// of the "LoginBySmsCode" endpoint of the "User" service.
func NewLoginBySmsCodeResponseBody(res *user.LoginBySmsCodeResult) *LoginBySmsCodeResponseBody {
...
// NewSendSmsCodeResponseBody builds the HTTP response body from the result of
// the "SendSmsCode" endpoint of the "User" service.
func NewSendSmsCodeResponseBody(res *user.SendSmsCodeResult) *SendSmsCodeResponseBody {
...
// NewLoginBySmsCodeInternalServerErrorResponseBody builds the HTTP response
// body from the result of the "LoginBySmsCode" endpoint of the "User" service.
func NewLoginBySmsCodeInternalServerErrorResponseBody(res *goa.ServiceError) *LoginBySmsCodeInternalServerErrorResponseBody {
...
// NewLoginBySmsCodeBadRequestResponseBody builds the HTTP response body from
// the result of the "LoginBySmsCode" endpoint of the "User" service.
func NewLoginBySmsCodeBadRequestResponseBody(res *goa.ServiceError) *LoginBySmsCodeBadRequestResponseBody {
...
// NewSendSmsCodeInternalServerErrorResponseBody builds the HTTP response body
// from the result of the "SendSmsCode" endpoint of the "User" service.
func NewSendSmsCodeInternalServerErrorResponseBody(res *goa.ServiceError) *SendSmsCodeInternalServerErrorResponseBody {
...
// NewSendSmsCodeBadRequestResponseBody builds the HTTP response body from the
// result of the "SendSmsCode" endpoint of the "User" service.
func NewSendSmsCodeBadRequestResponseBody(res *goa.ServiceError) *SendSmsCodeBadRequestResponseBody {
...
// NewLoginBySmsCodePayload builds a User service LoginBySmsCode endpoint
// payload.
func NewLoginBySmsCodePayload(body *LoginBySmsCodeRequestBody) *user.LoginBySmsCodePayload {
...
// NewSendSmsCodePayload builds a User service SendSmsCode endpoint payload.
func NewSendSmsCodePayload(body *SendSmsCodeRequestBody) *user.SendSmsCodePayload {
...
// ValidateLoginBySmsCodeRequestBody runs the validations defined on
// LoginBySmsCodeRequestBody
func ValidateLoginBySmsCodeRequestBody(body *LoginBySmsCodeRequestBody) (err error) {
	if body.Mobile == nil {
...
// ValidateSendSmsCodeRequestBody runs the validations defined on
// SendSmsCodeRequestBody
func ValidateSendSmsCodeRequestBody(body *SendSmsCodeRequestBody) (err error) {
	if body.Mobile == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("mobile", "body"))
	}
	if body.HumanCode == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("humanCode", "body"))
	}
	if body.CaptchaID == nil {
