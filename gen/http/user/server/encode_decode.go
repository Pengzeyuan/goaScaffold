...
// EncodeLoginBySmsCodeResponse returns an encoder for responses returned by
// the User LoginBySmsCode endpoint.
func EncodeLoginBySmsCodeResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, interface{}) error {
	return func(ctx context.Context, w http.ResponseWriter, v interface{}) error {
		res := v.(*user.LoginBySmsCodeResult)
		enc := encoder(ctx, w)
		body := NewLoginBySmsCodeResponseBody(res)
		w.WriteHeader(http.StatusOK)
		return enc.Encode(body)
	}
}

// DecodeLoginBySmsCodeRequest returns a decoder for requests sent to the User
// LoginBySmsCode endpoint.
func DecodeLoginBySmsCodeRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (interface{}, error) {
	return func(r *http.Request) (interface{}, error) {
		var (
		...
		err = ValidateLoginBySmsCodeRequestBody(&body)
		if err != nil {
			return nil, err
		}
		payload := NewLoginBySmsCodePayload(&body)

		return payload, nil
	}
}

// EncodeLoginBySmsCodeError returns an encoder for errors returned by the
// LoginBySmsCode User endpoint.
func EncodeLoginBySmsCodeError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		en, ok := v.(ErrorNamer)
		if !ok {
		...
		case "internal_server_error":
			...
			if formatter != nil {
				...
				body = NewLoginBySmsCodeInternalServerErrorResponseBody(res)
			}
			w.Header().Set("goa-error", "internal_server_error")
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "bad_request":
			...
			if formatter != nil {
				...
				body = NewLoginBySmsCodeBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", "bad_request")
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
...
// EncodeSendSmsCodeResponse returns an encoder for responses returned by the
// User SendSmsCode endpoint.
func EncodeSendSmsCodeResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, interface{}) error {
	return func(ctx context.Context, w http.ResponseWriter, v interface{}) error {
		res := v.(*user.SendSmsCodeResult)
		enc := encoder(ctx, w)
		body := NewSendSmsCodeResponseBody(res)
		w.WriteHeader(http.StatusOK)
		return enc.Encode(body)
	}
}

// DecodeSendSmsCodeRequest returns a decoder for requests sent to the User
// SendSmsCode endpoint.
func DecodeSendSmsCodeRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (interface{}, error) {
	return func(r *http.Request) (interface{}, error) {
		var (
		...
		err = ValidateSendSmsCodeRequestBody(&body)
		if err != nil {
			return nil, err
		}
		payload := NewSendSmsCodePayload(&body)

		return payload, nil
	}
}

// EncodeSendSmsCodeError returns an encoder for errors returned by the
// SendSmsCode User endpoint.
func EncodeSendSmsCodeError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		en, ok := v.(ErrorNamer)
		if !ok {
		...
		case "internal_server_error":
			...
			if formatter != nil {
				...
				body = NewSendSmsCodeInternalServerErrorResponseBody(res)
			}
			w.Header().Set("goa-error", "internal_server_error")
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "bad_request":
			...
			if formatter != nil {
				...
				body = NewSendSmsCodeBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", "bad_request")
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
