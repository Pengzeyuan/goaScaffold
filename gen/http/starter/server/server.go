...
// Server lists the starter service endpoint HTTP handlers.
type Server struct {
	Mounts          []*MountPoint
...
// New instantiates HTTP handlers for all the starter service endpoints using
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"LoginByUsername", "POST", "/starter/login_by_username"},
		},
...
func (s *Server) Service() string { return "starter" }
...
// Mount configures the mux to serve the starter endpoints.
func Mount(mux goahttp.Muxer, h *Server) {
	MountLoginByUsernameHandler(mux, h.LoginByUsername)
}

// MountLoginByUsernameHandler configures the mux to serve the "starter"
// service "LoginByUsername" endpoint.
func MountLoginByUsernameHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/starter/login_by_username", f)
}

// NewLoginByUsernameHandler creates a HTTP handler which loads the HTTP
// request and calls the "starter" service "LoginByUsername" endpoint.
func NewLoginByUsernameHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "starter")
