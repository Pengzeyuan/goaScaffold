...
var _ = Service("User", func() {
	...
	Method("LoginBySmsCode", func() {
		Description("使用短信验证码登录")
		Meta("swagger:summary", "使用短信验证码登录")
		...
		Payload(func() {
			...
			Attribute("verify_code", String, "短信验证码", func() {
				MinLength(4)
				MaxLength(6)
				Example("123456")
			})
			Required("mobile", "verify_code")
		})
	...
	Method("SendSmsCode", func() {
		Description("发送短信验证码")
		Meta("swagger:summary", "发送短信验证码")
		...
		Payload(func() {
			...
			Required("mobile", "humanCode", "captchaId")
		})
